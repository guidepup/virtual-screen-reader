...
describe("HTML-AAM Role Verification Tests", () => {
  ...
  test("verifies roles", async () => {
    expect(await virtual.spokenPhraseLog()).toEqual([
      ...
      "x",
      "end of group",
      "article, position 1, group size 1",
      "x",
      "end of article, position 1, group size 1",
      "navigation",
      "complementary, x",
      "complementary",
      "x",
      ...
      "textbox",
      "radio, not checked, position 1, group size 1",
      ...
      "option, x, position 1, group size 2, not selected",
      "option, x, position 2, group size 2, not selected",
      ...
      "option, b1, position 1, group size 2, not selected",
      "option, b2, position 2, group size 2, not selected",
