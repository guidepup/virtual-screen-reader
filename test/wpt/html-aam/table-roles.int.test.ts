...
describe("HTML-AAM Table Role Verification Tests", () => {
  ...
  test("verifies roles", async () => {
    expect(await virtual.spokenPhraseLog()).toEqual([
      ...
      "caption, caption",
      "rowgroup",
      "row, a b c, position 1, group size 1",
      "columnheader, a",
      "columnheader, b",
      "columnheader, c",
      "end of row, a b c, position 1, group size 1",
      "end of rowgroup",
      "rowgroup",
      "row, 1 2 3, position 1, group size 2",
      "columnheader, 1",
      "cell, 2",
      "cell, 3",
      "end of row, 1 2 3, position 1, group size 2",
      "row, 4 5 6, position 2, group size 2",
      "columnheader, 4",
      "cell, 5",
      "cell, 6",
      "end of row, 4 5 6, position 2, group size 2",
      "end of rowgroup",
      "rowgroup",
      "row, x y z, position 1, group size 1",
      "columnheader, x",
      "columnheader, y",
      "columnheader, z",
      "end of row, x y z, position 1, group size 1",
      "end of rowgroup",
